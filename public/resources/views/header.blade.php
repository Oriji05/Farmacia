        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <img class="imageUser w-1/3 xl:w-1/5 md:w-1/4 max-w-[25px]" src="../Carillo_Asset/asset/icon/icon_user.svg" alt="">
                </div>
                <div
                    class="imageUserContainer w-4/12 lg:w-2/12 lg:order-1 flex justify-center lg:justify-start items-center lg:mr-2.5">
                    <img class="imageUser carilloLogo w-auto h-[72px]" src="../Carillo_Asset\asset\logo_carillo.svg"
                        alt="">
                </div>
                <div
                    class="imageUserContainer w-2/12 lg:order-4 lg:w-1/12 flex justify-center lg:justify-end items-center  ">
                    <img class="imageUser w-1/3 md:w-1/4 xl:w-1/5 max-w-[25px]" src="../Carillo_Asset/asset/icon/icon_heart.svg" alt="">
                </div>
                <div
                    class="imageUserContainer w-2/12 lg:order-5 lg:w-1/12 flex justify-center lg:justify-end items-center">
                    <img class="imageUser w-1/3 md:w-1/4 xl:w-1/5 max-w-[25px]" src="../Carillo_Asset/asset/icon/icon_cart.svg" alt="">
                </div>
                <div
